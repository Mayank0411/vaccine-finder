                ...
                for (var j = 0; j < jp.centers[i].sessions.length; j++) {
                  if (req.body.age < 45 && req.body.age >= 18) {
                    if (jp.centers[i].sessions[j].min_age_limit === 18 && jp.centers[i].sessions[j].vaccine === req.body.vaccineName) {
                      ...
                      res.write(
                        "<div style='font-weight: bold; text-align: center; width:100%; height: 50%; margin:0; font-family: 'Droid Sans', sans-serif; color:#666666; font-size:12px; border:0; height:100%; line-height: 25px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;'><p><h2 style='color:red'>" +
